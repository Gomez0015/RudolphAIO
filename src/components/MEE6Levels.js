    ...
    <div style={{textAlign: 'center'}}>
        ...
        >
          <form action='#' style={{textAlign: 'center'}} autocomplete="off" onSubmit={saveSettings}>
            ...
            <Input autocomplete="off" required type="number" step="1" min='5' name="endTimer" defaultValue={botSettings.endTimer} placeholder="Minutes until bot stops farming" style={{textAlign: 'center', width: '50%'}}/>
            <br />
        ...
        <form autocomplete="off" action='#' style={{textAlign: 'center'}} onSubmit={startFarming}>
            ...
            <br />
            <Input autocomplete="off" required type="number" step="1" min='30' name="endTimer" placeholder="Minutes until bot stops farming" style={{textAlign: 'center', width: '25%'}}/>
            <br />
